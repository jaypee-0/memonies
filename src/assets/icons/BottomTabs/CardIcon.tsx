...
import Svg, { Path, G, ClipPath, Defs, Rect, Ellipse } from 'react-native-svg';
...
const SvgComponent = ({ focus }: Props) => (
  <Svg
    width='24'
    height='24'
    viewBox='0 0 24 24'
    ...
    <G clip-path='url(#clip0_811_2161)'>
      <Path
        ...
        fill={focus ? colors.primary : colors.secondary}
      />
    </G>
    <Defs>
      <ClipPath id='clip0_811_2161'>
